...
CREATE OR REPLACE FUNCTION atlas.search_data(keyword varchar, data_id uuid) RETURNS SETOF atlas.text_result AS
$$
    DECLARE
        key record;
        sql VARCHAR;
...
CREATE OR REPLACE FUNCTION atlas.search_data_lev(keyword varchar, data_id uuid) RETURNS SETOF atlas.text_result AS
$$
    DECLARE
        key record;
        sql VARCHAR;
...
CREATE OR REPLACE FUNCTION atlas.search_data_soundex(keyword varchar, data_id uuid) RETURNS SETOF atlas.text_result AS
$$
    DECLARE
        key record;
        sql VARCHAR;
